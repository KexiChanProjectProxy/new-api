...
// applyClientIPForward writes X-Forwarded-For using overwrite semantics when the
// channel setting is enabled and the resolved client IP is non-empty.
// Empty resolved IP leaves any existing XFF untouched.
