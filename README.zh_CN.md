...
| `LANGFUSE_REQUEST_LOG_ENABLED` | 启用 Langfuse 请求审计日志记录                                    | `false` |
| `LANGFUSE_REQUEST_LOG_BASE_URL` | Langfuse 基础 URL（例如 `https://cloud.langfuse.com`）          | - |
| `LANGFUSE_REQUEST_LOG_PUBLIC_KEY` | Langfuse 公钥（Basic Auth 用户名）                              | - |
| `LANGFUSE_REQUEST_LOG_SECRET_KEY` | Langfuse 私钥（Basic Auth 密码）                                | - |
