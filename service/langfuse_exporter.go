...
func buildLangfuseIngestionBody(snapshot *LangfuseAuditSnapshot) ([]byte, error) {
	...
	meta := map[string]any{
		...
		"channel_type":              snapshot.Metadata.ChannelType,
		"upstream_model_name":       snapshot.Metadata.UpstreamModelName,
		"is_model_mapped":           snapshot.Metadata.IsModelMapped,
		"request_id":                snapshot.Metadata.RequestId,
		"upstream_request_id":       snapshot.Metadata.UpstreamRequestId,
		"client_ip":                 snapshot.Metadata.ResolvedClientIP,
		"username":                  snapshot.Metadata.Username,
		"user_id":                   snapshot.Metadata.UserId,
		"user_email":                snapshot.Metadata.UserEmail,
		"user_quota":                snapshot.Metadata.UserQuota,
		"token_name":                snapshot.Metadata.TokenName,
		"token_key":                 snapshot.Metadata.MaskedTokenKey,
		"token_unlimited":           snapshot.Metadata.TokenUnlimited,
		"relay_format":              snapshot.Metadata.RelayFormat,
		"relay_mode":                snapshot.Metadata.RelayMode,
		"request_url_path":          snapshot.Metadata.RequestURLPath,
		"reasoning_effort":          snapshot.Metadata.ReasoningEffort,
		"using_group":               snapshot.Metadata.UsingGroup,
		"retry_chain":               snapshot.Metadata.RetryChain,
		"retry_index":               snapshot.Metadata.RetryIndex,
		"billing_source":            snapshot.Metadata.BillingSource,
		"subscription_plan":         snapshot.Metadata.SubscriptionPlanTitle,
		"final_pre_consumed_quota":  snapshot.Metadata.FinalPreConsumedQuota,
		"use_price":                 snapshot.Metadata.UsePrice,
		...
		"first_response_latency_ms": snapshot.Metadata.FirstResponseLatencyMs,
		"total_latency_ms":          snapshot.Metadata.TotalLatencyMs,
		"is_stream":                 snapshot.Metadata.IsStream,
		"is_playground":             snapshot.Metadata.IsPlayground,
		"is_channel_test":           snapshot.Metadata.IsChannelTest,
	}
