...
const OPERATIONS_SECTIONS = [
	...
	{
		id: "langfuse",
		titleKey: "Langfuse Request Logging",
		build: (settings: OperationsSettings) => (
			<LangfuseSettingsSection
				defaultValues={{
					LangfuseRequestLogEnabled: settings.LangfuseRequestLogEnabled,
					LangfuseRequestLogBaseURL: settings.LangfuseRequestLogBaseURL,
					LangfuseRequestLogPublicKey: settings.LangfuseRequestLogPublicKey,
					LangfuseRequestLogSecretKey: settings.LangfuseRequestLogSecretKey,
				}}
			/>
		),
	},
